    ...
    <form action="{{route('skill.update')}}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input
                ...
                placeholder="Programming Language and Tools"
                value="{{ get_meta_value('_language') }}"
            />
        </div>
        <div class="mb-3">
            <label for="isi" class="form-label">Workflow</label>
            <textarea class="form-control summernote" name="_workflow" id="isi" cols="30" rows="5">{{ get_meta_value('_workflow') }}</textarea>
        </div>
